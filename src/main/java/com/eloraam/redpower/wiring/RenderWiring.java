...
public abstract class RenderWiring extends RenderCovers {
        ...
        switch (n) {
            case 2:
                super.context.setSize(
                    0.0,
                    0.0,
                    (double) (0.5F - this.wireWidth),
                    (double) (0.5F - this.wireWidth),
                    (double) this.wireHeight,
                    (double) (0.5F + this.wireWidth)
                );
    ...
    public void setSideIcon(IIcon top, IIcon cent, IIcon cfix) {
        for (int j = 0; j < 6; ++j) {
    ...
    public void setSideIconJumbo(
        IIcon sides, IIcon top, IIcon cent, IIcon centside, IIcon end, IIcon corners
    ) {
        for (int j = 0; j < 6; ++j) {
    ...
    public void renderEndCaps(int cs, int fn) {
        if (cs != 0) {
            ...
            if ((cs & 1) > 0) {
                ...
                super.context.setRelPos(0.0, 0.0, -1.0);
                super.context.setTexFlags(38444);
            ...
            if ((cs & 4) > 0) {
                ...
                super.context.setRelPos(-1.0, 0.0, 0.0);
                if (fn != 2 && fn != 4) {
                    super.context.setTexFlags(3);
                } else {
                    super.context.setTexFlags(45658);
                }

                super.context.setLocalLights(0.7F, 1.0F, 0.7F, 0.7F, 1.0F, 0.7F);
                super.context.calcBounds();
            ...
            if ((cs & 8) > 0) {
                ...
                super.context.setLocalLights(0.7F, 1.0F, 0.7F, 0.7F, 0.7F, 1.0F);
                super.context.calcBounds();
    ...
    public void renderWireBlock(int consides, int cons, int indcon, int indconex) {
        ...
        if ((consides & 1) > 0) {
            ...
            this.renderSideWires(
                RedPowerLib.mapConToLocal(cons, 0), RedPowerLib.mapConToLocal(ucons, 0), 0
            );
        ...
        if ((consides & 2) > 0) {
            ...
            this.renderSideWires(
                RedPowerLib.mapConToLocal(cons, 1), RedPowerLib.mapConToLocal(ucons, 1), 1
            );
        ...
        if ((consides & 4) > 0) {
            ...
            this.renderSideWires(
                RedPowerLib.mapConToLocal(cons, 2), RedPowerLib.mapConToLocal(ucons, 2), 2
            );
        ...
        if ((consides & 8) > 0) {
            ...
            this.renderSideWires(
                RedPowerLib.mapConToLocal(cons, 3), RedPowerLib.mapConToLocal(ucons, 3), 3
            );
        ...
        if ((consides & 16) > 0) {
            ...
            this.renderSideWires(
                RedPowerLib.mapConToLocal(cons, 4), RedPowerLib.mapConToLocal(ucons, 4), 4
            );
        ...
        if ((consides & 32) > 0) {
            ...
            this.renderSideWires(
                RedPowerLib.mapConToLocal(cons, 5), RedPowerLib.mapConToLocal(ucons, 5), 5
            );
    ...
    public void renderCenterBlock(int cons, IIcon[] icon, IIcon sidtex) {
        switch (cons) {
            case 0:
                ...
                super.context.renderBox(63, 0.25, 0.25, 0.25, 0.75, 0.75, 0.75);
                break;
            case 3:
                this.setJacketIcons(3, icon, sidtex);
            ...
            case 12:
                ...
                super.context.renderBox(63, 0.25, 0.25, 0.0, 0.75, 0.75, 1.0);
                break;
            case 48:
                this.setJacketIcons(48, icon, sidtex);
                super.context.renderBox(63, 0.0, 0.25, 0.25, 1.0, 0.75, 0.75);
                break;
            default:
                ...
                super.context.renderBox(63 ^ cons, 0.25, 0.25, 0.25, 0.75, 0.75, 0.75);
                if ((cons & 1) > 0) {
                    this.setJacketIcons(1, icon, sidtex);
                    super.context.renderBox(61, 0.25, 0.0, 0.25, 0.75, 0.25, 0.75);
                }

                if ((cons & 2) > 0) {
                    this.setJacketIcons(2, icon, sidtex);
                    super.context.renderBox(62, 0.25, 0.75, 0.25, 0.75, 1.0, 0.75);
                }

                if ((cons & 4) > 0) {
                    this.setJacketIcons(4, icon, sidtex);
                    super.context.renderBox(55, 0.25, 0.25, 0.0, 0.75, 0.75, 0.25);
                }

                if ((cons & 8) > 0) {
                    this.setJacketIcons(8, icon, sidtex);
                    super.context.renderBox(59, 0.25, 0.25, 0.75, 0.75, 0.75, 1.0);
                }

                if ((cons & 16) > 0) {
                    this.setJacketIcons(16, icon, sidtex);
                    super.context.renderBox(31, 0.0, 0.25, 0.25, 0.25, 0.75, 0.75);
                }

                if ((cons & 32) > 0) {
                    this.setJacketIcons(32, icon, sidtex);
                    super.context.renderBox(47, 0.75, 0.25, 0.25, 1.0, 0.75, 0.75);
                }
        }
    }
}
